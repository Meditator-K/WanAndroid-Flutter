class NaviEntity {
	...
	NaviEntity.fromJson(Map<String, dynamic> json) {
		...
		if (json['articles'] != null) {
			articles = new List<NaviArticle>();(json['articles'] as List).forEach((v) { articles.add(new NaviArticle.fromJson(v)); });
		}
		cid = json['cid'];
	}
