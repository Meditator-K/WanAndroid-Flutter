class ArticleEntity {
	...
	ArticleEntity({this.over, this.pageCount, this.total, this.curPage, this.offset, this.size, this.datas});
	...
	ArticleEntity.fromJson(Map<String, dynamic> json) {
		...
		size = json['size'];
		if (json['datas'] != null) {
			datas = new List<ArticleData>();(json['datas'] as List).forEach((v) { datas.add(new ArticleData.fromJson(v)); });
		}
	}
