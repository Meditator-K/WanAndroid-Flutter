class ProjectListEntity {
	...
	ProjectListEntity({this.over, this.pageCount, this.total, this.curPage, this.offset, this.size, this.datas});
	...
	ProjectListEntity.fromJson(Map<String, dynamic> json) {
		...
		size = json['size'];
		if (json['datas'] != null) {
			datas = new List<ProjectListData>();(json['datas'] as List).forEach((v) { datas.add(new ProjectListData.fromJson(v)); });
		}
	}
...
class ProjectListData {
	...
	ProjectListData.fromJson(Map<String, dynamic> json) {
		...
		userId = json['userId'];
		if (json['tags'] != null) {
			tags = new List<ProjectListDatasTag>();(json['tags'] as List).forEach((v) { tags.add(new ProjectListDatasTag.fromJson(v)); });
		}
